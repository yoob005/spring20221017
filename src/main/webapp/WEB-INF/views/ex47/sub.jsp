...
<body>
	...
	<br>
	<button id="btn14">/ex47/sub14 post 요청 : 고객정보 delete</button>
	
	<br>
	<input type="number" id="deleteSupplierInput15">
	<button id="btn15">공급자 정보 삭제해보자</button>
...
document.querySelector("#btn15").addEventListener("click", function() {
	...
	const id = document.querySelector("#deleteSupplierInput15").value;
